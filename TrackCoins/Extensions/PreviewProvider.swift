...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$22.5Bn", percentageChange: 35.34)
    let stat2 = StatisticModel(title: "Total Volume", value: "$2.24Tr")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "$70.4k", percentageChange: -22.34)
